...
class BookingPage(QWidget):
    ...
    def create_ui(self):
        ...
        self.room_number = QLineEdit(str(self.room_data.get('id', '')))
    ...
    def submit_booking(self):
        ...
        if not all([
            ...
            QMessageBox.warning(self, "Error", "Please fill in all payment details")
            return
        ...
        try:
            ...
            response = requests.post('http://127.0.0.1:5000/booking', json=request_data)

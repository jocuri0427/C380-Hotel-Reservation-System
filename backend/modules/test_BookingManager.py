...
from backend.modules.BookingManager import BookingManager, InvalidDateRangeError, UserNotFoundError, RoomNotFoundError, RoomUnavailableError, BookingNotFoundError
...
class TestBookingManager(unittest.TestCase):
    ...
    @patch('backend.modules.BookingManager.Booking', new=MockBooking)

...
class Databasecentralsystem:
    ...
    def Cancel_reservation(self, reservation_id):
        self.cursor.execute(
            "SELECT room_num FROM Reservation WHERE num=%s", (reservation_id,))
        ...
        self.cursor.execute(
            "DELETE FROM Reservation WHERE num=%s", (reservation_id,))
        self.cursor.execute(
            "UPDATE rooms SET Reserved = FALSE WHERE num=%s", (room_num,))
        self.db.commit()
        return True
